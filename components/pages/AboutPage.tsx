...
const L = {
  ...
  blue: '#1B4FFF', blue2: '#4F8EF7', blue3: '#93C5FD',
};
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                ...
                <p key={i} style={{ color: L.t3, lineHeight: 1.75, fontSize: '0.9375rem' }}>{p}</p>
              ))}
              <p style={{ color: L.t1, fontFamily: 'var(--fd)', fontWeight: 700, fontSize: '1rem', marginTop: 8, borderLeft: `3px solid ${L.blue}`, paddingLeft: 16 }}>
      ...
      <div className="wrap">
        ...
        <Stagger>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 28 }}>
            {[
              {
                initials: 'DC', name: 'David Chandler',
                role: 'Co-Founder — Strategy & Client Relations', cred: 'Co-founder, WhirLocal.io',
              ...
              {
                initials: 'BL', name: 'Bri Lindley',
                role: 'Co-Founder — Technology & Marketing Systems', cred: 'Founder, Lindley Team — #1 Google ranking + AI search',
              ...
              <div key={member.initials} style={{ background: L.bg, border: `1.5px solid ${L.border}`, borderRadius: 'var(--rxl)', padding: 32, boxShadow: '0 1px 4px rgba(15,23,42,0.04)' }}>
                ...
                <p style={{ fontSize: '0.875rem', color: L.t3, lineHeight: 1.75 }}>{member.bio2}</p>
              </div>
            ))}
          </div>
        </Stagger>
