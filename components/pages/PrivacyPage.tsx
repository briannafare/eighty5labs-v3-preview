  ...
  <div style={{ minHeight: '100vh', background: '#FFFFFF', padding: 'calc(var(--nav-h) + 48px) 16px 96px' }}>
    <div style={{ maxWidth: 768, marginInline: 'auto' }}>
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 800, letterSpacing: '-0.05em', color: '#0F172A', marginBottom: 16 }}>Privacy Policy</h1>
      ...
      <div style={{ background: '#F7F9FF', borderRadius: 16, border: '1px solid #DDE5F2', padding: 'clamp(32px, 5vw, 48px)' }}>
        ...
        <SubSection title="3.1 How We Share Your Information">
          <p style={{ ...p, fontWeight: 600 }}>We are committed to protecting your privacy. <strong>We will NOT share your mobile contact information with third parties or affiliates for marketing or promotional purposes.</strong></p>
