  ...
  <div style={{ minHeight: '100vh', background: '#fbfbfa', padding: '64px 16px 96px' }}>
    <div style={{ maxWidth: 768, marginInline: 'auto' }}>
      ...
      <div style={{ marginBottom: 48 }}>
        ...
        <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 900, letterSpacing: '-0.05em', color: '#111', marginBottom: 16 }}>Terms and Conditions</h1>
      ...
      <div style={{ marginTop: 32, textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
        <a href="#/privacy" onClick={e => { e.preventDefault(); navigate('#/privacy'); }} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, fontSize: '0.875rem', fontWeight: 600, color: '#f36421', textDecoration: 'none' }}>
